(function () {
  ...
  SocialAccountsController.$inject = ['$state', '$window', 'UsersService', 'appService', 'Notification'];

  function SocialAccountsController($state, $window, UsersService, appService, Notification) {
    var vm = this;
