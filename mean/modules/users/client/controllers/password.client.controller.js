(function () {
  ...
  PasswordController.$inject = ['$scope', '$stateParams', 'UsersService', '$location', 'appService', 'PasswordValidator', 'Notification'];

  function PasswordController($scope, $stateParams, UsersService, $location, appService, PasswordValidator, Notification) {
    var vm = this;
