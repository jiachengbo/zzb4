(function () {
  ...
  angular
    ...
    .factory('GetTaskProgressService', GetTaskProgressService);

  GetTaskProgressService.$inject = ['$resource', '$log'];

  function GetTaskProgressService($resource, $log) {
    var Task = $resource('/api/gettaskprogress');
