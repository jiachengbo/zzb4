(function () {
  ...
  angular
    .module('page')
    .controller('PageBasicMsgDwController', PageBasicMsgDwController);

  PageBasicMsgDwController.$inject = ['$scope', 'PartymapServiceCore', 'PartyBuildingService', '$window',
  ...
  function PageBasicMsgDwController($scope, PartymapServiceCore, PartyBuildingService, $window,
                                    baseCodeService, $state, menuService, NoticeFileService, appService, $timeout, $filter, PartyBuildingSbService, memberNumService, PartyMemberAnalyzeService) {
    var vm = this;
    ...
    vm.analyze = function (type) {
      if (type === 'num') {
        PartyMemberAnalyzeService.query({isDWnum: true}).$promise.then(function (data) {
          console.log(data);
          var legenddata = [];
          var seriesdata = [];
          var xAxisdata = [];
        ...
        PartyMemberAnalyzeService.query({isDWsex: true}).$promise.then(function (data) {
          var legenddata = [];
          var seriesdata = [];
          var xAxisdata = [];
          var seriesdata2 = [];
        ...
        PartyMemberAnalyzeService.query({isDWage: true}).$promise.then(function (data) {
          var legenddata = [];
          var seriesdata = [];
          var xAxisdata = [];
          var seriesdata2 = [];
        ...
        PartyMemberAnalyzeService.query({isDWjointime: true}).$promise.then(function (data) {
          var legenddata = [];
          var seriesdata = [];
          var xAxisdata = [];
          var seriesdata2 = [];
        ...
        PartyMemberAnalyzeService.query({isDWorgnum: true}).$promise.then(function (data) {
          var legenddata = [];
          var seriesdata = [];
          var xAxisdata = [];
          var seriesdata2 = [];
        ...
        PartyMemberAnalyzeService.query({isDWunitclass: true}).$promise.then(function (data) {
          console.log(data);
          var legenddata = [];
          var seriesdata = [];
          var xAxisdata = [];
        ...
        PartyMemberAnalyzeService.query({isDWorgpersonnum: true}).$promise.then(function (data) {
          console.log(data);
          var legenddata = [];
          var seriesdata = [];
          var xAxisdata = [];
        ...
        PartyMemberAnalyzeService.query({isDWorgclass: true}).$promise.then(function (data) {
          console.log(data);
          var legenddata = [];
          var seriesdata = [];
          var xAxisdata = [];
